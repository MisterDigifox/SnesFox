...
public:
    ...
    bool    porFreezeHigh() const { return m_porFreezeHigh; }
    bool    porHighNibble() const { return m_porHighNibble; }
    bool    porDither() const { return m_porDither; }
    bool    porTransparent() const { return m_porTransparent; }
    bool    cfgrIrq() const { return m_cfgrIrq; }
    bool    cfgrMs0() const { return m_cfgrMs0; }
    uint8_t scmrMd() const { return m_scmrMd; }
    uint8_t scmrHt() const { return m_scmrHt; }
    bool    scmrRan() const { return m_scmrRan; }
    bool    scmrRon() const { return m_scmrRon; }
    bool    bramr() const { return m_bramr; }
    uint8_t vcr() const { return m_vcr; }
    uint16_t cbr() const { return m_cbr; }
...
private:
    ...
    int m_pipeCallCount = 0;  // number of pipe() calls made by the instruction currently executing
